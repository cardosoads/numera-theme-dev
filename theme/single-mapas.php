    ...
    <div class="container mx-auto p-4 max-w-[1400px]">
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            <div class="entry-content">
                ...
                <div id="tabs-content">
                    <!-- Tab 1 Content -->
                    <div data-tab-content="tab1" class="p-6">
                        <div class="space-y-6">
                            <!-- Análise de Assinatura -->
                            <div class="bg-white border border-gray-300 rounded-2xl p-6 shadow-md">
                                <h2 class="text-2xl font-semibold text-gray-900 text-center mb-6">Análise de Assinatura</h2>
                                <div class="space-y-4">
                                    <!-- Consoantes (Impressões) -->
                                    <div class="flex justify-center flex-wrap gap-2">
                                        ...
                                        <?php foreach ($letras_nome as $letra): ?>
                                            <div class="flex flex-col items-center w-10">
                                                ...
                                                <?php endif; ?>
                                                <div class="text-gray-900 font-medium mt-1"><?php echo esc_html($letra); ?></div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                    ...
                                    <div class="flex justify-center flex-wrap gap-2">
                                        ...
                                        for ($i = 0; $i < count($letras_nome); $i++) {
                                            if ($indice_parte < count($posicoes_partes) && $i === $posicoes_partes[$indice_parte]['posicao']) {
                                                echo '<div class="flex flex-col items-center w-10">';
                                    ...
                                    <div class="flex flex-wrap gap-4 justify-center py-4">
                                        ...
                                        foreach ($legendas as $legenda => $cor): ?>
                                            <div class="flex items-center gap-2">
                                                <span class="block w-4 h-4 <?php echo esc_html($cor); ?> rounded-full shadow"></span>
                                                <p class="text-gray-600 text-sm"><?php echo esc_html($legenda); ?></p>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                            ...
                            <div class="bg-gray-50 border border-gray-300 rounded-2xl p-6 shadow-md">
                                <h3 class="text-2xl font-semibold text-gray-900 mb-6">Resultados dos Cálculos</h3>
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                    <!-- Motivação -->
                                    <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                        <div class="flex items-center justify-between">
                                            <span id="resultado-motivacao" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $numero_motivacao ?></span>
                                            <span class="text-lg font-medium text-gray-800">Motivação</span>
                                        </div>
                                        <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-motivacao">Ver detalhes</a>
                                    </div>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                        <div class="flex items-center justify-between">
                                            <span id="resultado-impressao" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $numero_impressao ?></span>
                                            <span class="text-lg font-medium text-gray-800">Impressão</span>
                                        </div>
                                        <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-impressao">Ver detalhes</a>
                                    </div>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                        <div class="flex items-center justify-between">
                                            <span id="resultado-expressao" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $numero_expressao ?></span>
                                            <span class="text-lg font-medium text-gray-800">Expressão</span>
                                        </div>
                                        <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-expressao">Ver detalhes</a>
                                    </div>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                        <div class="flex items-center justify-between">
                                            <span id="resultado-arcano" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $arcanoAtual['arcano'] ?></span>
                                    ...
                                    <div id="modal-arcano" class="modal hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                                        <div class="bg-white p-6 rounded-2xl shadow-lg max-w-4xl w-full">                                                                                                                                                                                                                                                                                                                                                           
                                            ...
                                            <div class="flex justify-end mt-4">
                                                <button class="closeModal py-2 px-4 bg-red-600 text-white rounded-lg hover:bg-red-700 transition">Fechar</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <!-- Harmonia Conjugal e Números Harmônicos -->
                                <div class="grid grid-cols-1 lg:grid-cols-1 gap-4 mt-6">
                                    ...
                                    <div class="bg-gray-50 border border-green-300 rounded-2xl p-6 shadow-sm">
                                        <h3 class="text-xl font-semibold text-gray-800 mb-4">Harmonia Conjugal <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium ml-2"><?php echo $harmonia ?></span></h3>
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-cols-fr">
                                            <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm flex flex-col items-start">
                                                <h4 class="font-semibold text-gray-800 mb-2">Vibra Com</h4>
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $vibra_com ?></span>
                                            </div>
                                            <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm flex flex-col items-start">
                                                <h4 class="font-semibold text-gray-800 mb-2">Atrai</h4>
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $atrai ?></span>
                                            </div>
                                            <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm flex flex-col items-start">
                                                <h4 class="font-semibold text-gray-800 mb-2">É Oposto</h4>
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $e_oposto ?></span>
                                            </div>
                                            <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm flex flex-col items-start">
                                                <h4 class="font-semibold text-gray-800 mb-2">É Passivo em relação a</h4>
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $e_passivo_em_relacao_a ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Números Harmônicos -->
                                    <div class="bg-gray-50 border border-green-300 rounded-2xl p-6 shadow-sm">
                                        <h3 class="text-xl font-semibold text-gray-800 mb-4">Números Harmônicos</h3>
                                        <div class="flex flex-wrap gap-2">
                                            <?php foreach ($numeros_harmonicos as $num): ?>
                                                <span id="resultado-numeros-harmonicos" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $num ?></span>
                                            <?php endforeach; ?>
                                        </div>
                                        <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-numeros-harmonicos">Ver detalhes</a>
                    ...
                    <!-- Tab 2 Content -->
                    <div data-tab-content="tab2" class="p-6 hidden">
                        <div class="space-y-6">
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <!-- Bloco Pessoal -->
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Pessoal</h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <!-- Missão -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-missao" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $numero_missao ?></span>
                                                <h3 class="font-semibold text-gray-800">Missão</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-missao">Ver detalhes</a>
                                        </div>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-destino" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $numero_destino ?></span>
                                                <h3 class="font-semibold text-gray-800">Destino</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-destino">Ver detalhes</a>
                                        </div>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-ano-pessoal" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $ano_pessoal ?></span>
                                                <h3 class="font-semibold text-gray-800">Ano Pessoal</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-ano-pessoal">Ver detalhes</a>
                                        </div>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-mes-pessoal" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $mes_pessoal ?></span>
                                                <h3 class="font-semibold text-gray-800">Mês Pessoal</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-mes-pessoal">Ver detalhes</a>
                                        </div>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-dia-pessoal" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $dia_pessoal ?></span>
                                                <h3 class="font-semibold text-gray-800">Dia Pessoal</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-dia-pessoal">Ver detalhes</a>
                                        </div>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-anjo" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo esc_html($anjo['numero']); ?></span>
                                                <h3 class="font-semibold text-gray-800">Anjo</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-anjo">Ver detalhes</a>
                                        </div>
                                ...
                                <!-- Bloco Carmas -->
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Carmas</h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <!-- Lições Cármicas -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Lições Cármicas</h3>
                                            <div class="flex flex-wrap gap-2">
                                                <?php
                                                if (!empty($licao_carmica)) {
                                                    foreach ($licao_carmica as $licao) {
                                                        echo '<span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium">' . esc_html($licao['numero_licao_carmica']) . '</span>';
                                                    }
                                                } else {
                                                    echo '<span class="bg-gray-100 text-gray-500 px-3 py-1 rounded-full">Sem Lições Cármicas</span>';
                                                }
                                                ?>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-licoes-carmicas">Ver detalhes</a>
                                            <?php foreach ($licao_carmica as $licao) {
                                        ...
                                        <!-- Dívidas Cármicas -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Dívidas Cármicas</h3>
                                            <div class="flex flex-wrap gap-2">
                                                <?php
                                                if (!empty($divida_carmica)) {
                                                    foreach ($divida_carmica as $divida) {
                                                        echo '<span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium">' . esc_html($divida['numero_divida_carmica']) . '</span>';
                                                    }
                                                } else {
                                                    echo '<span class="bg-gray-100 text-gray-500 px-3 py-1 rounded-full">Sem Dívidas Cármicas</span>';
                                                }
                                                ?>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-dividas-carmicas">Ver detalhes</a>
                                            <?php render_modal_divida('modal-dividas-carmicas', $divida_carmica); ?>
                                        </div>

                                        <!-- Tendências Ocultas -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Tendências Ocultas</h3>
                                            <div class="flex flex-wrap gap-2">
                                                <?php foreach ($resultado_tendencias as $tendencia): ?>
                                                    <span id="resultado-tendencias-ocultas" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $tendencia['numero_tendencia_oculta'] ?></span>
                                                <?php endforeach; ?>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-tendencias-ocultas">Ver detalhes</a>
                                            <?php render_modal_with_columns('modal-tendencias-ocultas', "Tendências Ocultas", $resultado_tendencias); ?>
                                        </div>

                                        <!-- Grau de Ascensão -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Grau de Ascensão</h3>
                                            <div class="flex items-center">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $grau_ascensao ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <!-- Bloco Dias Harmônicos e Cores -->
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <div class="grid grid-cols-1 sm:grid-cols-1 gap-4">
                                        <!-- Dias Harmônicos -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Dias Harmônicos</h3>
                                            <div class="flex flex-wrap gap-2">
                                                <?php foreach ($dias_favoraveis as $dia): ?>
                                                    <span id="resultado-dias-harmonicos" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $dia ?></span>
                                                <?php endforeach; ?>
                                            </div>
                                        </div>
                                        <!-- Cores -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <h3 class="font-semibold text-gray-800 mb-3">Cores</h3>
                                            <div class="flex flex-wrap gap-2">
                                                <span id="resultado-cores" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $cores ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $resultado_talento['numero_talento_oculto'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Talento Oculto</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-talento-oculto">Ver detalhes</a>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $resultado_numero_psiquico['numero_psiquico'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Número Psíquico</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-numero-psiquico">Ver detalhes</a>
                                        ...
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-numeros-harmonicos" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $relacoes_intervalores ?></span>
                                                <h3 class="font-semibold text-gray-800">Relações Intervalores</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-relacoes-intervalores">Ver detalhes</a>
                                            <?php render_modal('modal-relacoes-intervalores', "Relações Intervalores", !empty($resultado_relacoes_intervalor) && isset($resultado_relacoes_intervalor['texto_relacao_intervalor']) ? $resultado_relacoes_intervalor['texto_relacao_intervalor'] : "Nenhuma Relação Intervalor"); ?>
                                        </div>

                                        <!-- Resposta Subconsciente -->
                                        <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span id="resultado-numeros-harmonicos" class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $resposta_subconsciente ?></span>
                                                <h3 class="font-semibold text-gray-800">Resposta Subconsciente</h3>
                                            </div>
                                            <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-resposta-subconsciente">Ver detalhes</a>
                                            <?php render_modal('modal-resposta-subconsciente', "Resposta Subconsciente", $resultado_resposta_subconsciente['texto_resposta_subconsciente']); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!-- Tab 3 Content -->
                    <div data-tab-content="tab3" class="p-6 hidden">
                        <div class="space-y-6">
                            <h2 class="text-2xl font-semibold text-gray-900">Energias</h2>
                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                <!-- Bloco Desafios -->
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Desafios</h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <?php
                                        ...
                                        foreach ($resultado_desafios as $desafio): ?>
                                            <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                                <div class="flex items-center justify-between">
                                                    <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo esc_html($desafio['numero_do_desafio']); ?></span>
                                                    <h3 class="font-semibold text-gray-800"><?php echo esc_html($nomes_desafios[$contador]); ?> Desafio</h3>
                                                </div>
                                                <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-<?php echo strtolower($nomes_desafios[$contador]); ?>-desafio">Ver detalhes</a>
                                ...
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Ciclos da Vida</h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <?php if (!empty($ciclos['ciclos'])):
                                            ...
                                            foreach ($ciclos['ciclos'] as $nome_ciclo => $dados_ciclo): ?>
                                                <div class="border border-green-300 rounded-lg p-4 bg-white shadow-sm">
                                                    <div class="flex items-center justify-between">
                                                        <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo esc_html($dados_ciclo['numero']); ?></span>
                                                        <h3 class="font-semibold text-gray-800">
                                                            <?php
                                                            if ($contador == 1) echo "Primeiro Ciclo";
                                                            elseif ($contador == 2) echo "Segundo Ciclo";
                                                            elseif ($contador == 3) echo "Terceiro Ciclo";
                                                            ?>
                                                        </h3>
                                                    </div>
                                                    <div class="mt-2">
                                    ...
                                    <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-ciclo-vida">Ver detalhes</a>
                                ...
                                <div class="bg-gray-50 border border-yellow-300 rounded-2xl p-6 shadow-md">
                                    <h2 class="text-2xl font-semibold text-gray-800 mb-6">Momentos Decisivos</h2>
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                                        <div class="border border-purple-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $momentos_decisivos['primeiroMomento'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Primeiro Momento</h3>
                                            </div>
                                            <div class="mt-2">
                                                <p class="text-gray-500 text-sm font-semibold">Período</p>
                                                <p class="text-gray-800 text-sm"><?php echo $momentos_decisivos['momentoInicial1'] . ' até ' . $momentos_decisivos['momentoFinal1'] ?></p>
                                                <p class="text-gray-500 text-sm font-semibold">Duração: <?php echo ($momentos_decisivos['momentoFinal1'] - $momentos_decisivos['momentoInicial1']); ?> anos</p>
                                                <p class="text-gray-500 text-sm font-semibold">Idade: 0 até <?php echo ($momentos_decisivos['momentoFinal1'] - $momentos_decisivos['momentoInicial1']); ?> anos</p>
                                            </div>
                                        </div>
                                        <div class="border border-purple-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $momentos_decisivos['segundoMomento'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Segundo Momento</h3>
                                            </div>
                                            <div class="mt-2">
                                                <p class="text-gray-500 text-sm font-semibold">Período</p>
                                                <p class="text-gray-800 text-sm"><?php echo $momentos_decisivos['momentoInicial2'] . ' até ' . $momentos_decisivos['momentoFinal2'] ?></p>
                                                <p class="text-gray-500 text-sm font-semibold">Duração: <?php echo ($momentos_decisivos['momentoFinal2'] - $momentos_decisivos['momentoInicial2']); ?> anos</p>
                                                <p class="text-gray-500 text-sm font-semibold">Idade: <?php echo ($momentos_decisivos['momentoInicial2'] - $momentos_decisivos['momentoInicial1']); ?> até <?php echo ($momentos_decisivos['momentoFinal2'] - $momentos_decisivos['momentoInicial1']); ?> anos</p>
                                            </div>
                                        </div>
                                        <div class="border border-purple-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $momentos_decisivos['terceiroMomento'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Terceiro Momento</h3>
                                            </div>
                                            <div class="mt-2">
                                                <p class="text-gray-500 text-sm font-semibold">Período</p>
                                                <p class="text-gray-800 text-sm"><?php echo $momentos_decisivos['momentoInicial3'] . ' até ' . $momentos_decisivos['momentoFinal3'] ?></p>
                                                <p class="text-gray-500 text-sm font-semibold">Duração: <?php echo ($momentos_decisivos['momentoFinal3'] - $momentos_decisivos['momentoInicial3']); ?> anos</p>
                                                <p class="text-gray-500 text-sm font-semibold">Idade: <?php echo ($momentos_decisivos['momentoInicial3'] - $momentos_decisivos['momentoInicial1']); ?> até <?php echo ($momentos_decisivos['momentoFinal3'] - $momentos_decisivos['momentoInicial1']); ?> anos</p>
                                            </div>
                                        </div>
                                        <div class="border border-purple-300 rounded-lg p-4 bg-white shadow-sm">
                                            <div class="flex items-center justify-between">
                                                <span class="bg-purple-50 border border-purple-300 rounded-full px-3 py-1 text-purple-700 font-medium"><?php echo $momentos_decisivos['quartoMomento'] ?></span>
                                                <h3 class="font-semibold text-gray-800">Quarto Momento</h3>
                                            </div>
                                            <div class="mt-2">
                                                <p class="text-gray-500 text-sm font-semibold">Período</p>
                                                <p class="text-gray-800 text-sm"><?php echo $momentos_decisivos['momentoInicial4'] . ' até ' . $momentos_decisivos['momentoFinal4'] ?></p>
                                                <p class="text-gray-500 text-sm font-semibold">Idade: <?php echo ($momentos_decisivos['momentoInicial4'] - $momentos_decisivos['momentoInicial1']); ?> anos até o fim da vida</p>
                                            </div>
                                        </div>
                                    </div>
                                    <a href="#" class="text-blue-600 hover:underline mt-3 block text-right" data-modal="modal-momentos-decisivos">Ver detalhes</a>
                    ...
                    <!-- Tab 4 Content -->
                    <div data-tab-content="tab4" class="p-6 hidden">
                        <div class="tab-menu mb-6 flex justify-center space-x-4">
                            <button class="tab-link px-6 py-2 text-sm font-medium rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring focus:ring-blue-300 transition duration-200" onclick="openArcano(event, 'arcanoVida')">Vida</button>
                            <button class="tab-link px-6 py-2 text-sm font-medium rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring focus:ring-blue-300 transition duration-200" onclick="openArcano(event, 'arcanoTalento')">Pessoal</button>
                            <button class="tab-link px-6 py-2 text-sm font-medium rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring focus:ring-blue-300 transition duration-200" onclick="openArcano(event, 'arcanoAscensao')">Social</button>
                            <button class="tab-link px-6 py-2 text-sm font-medium rounded-full bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring focus:ring-blue-300 transition duration-200" onclick="openArcano(event, 'arcanoOculta')">Destino</button>
                        </div>

                        <div id="arcanoVida" class="arcano-container bg-gray-50 rounded-2xl p-6 shadow-md">
                            <h2 class="text-xl font-semibold text-gray-800 mb-6">Arcanos (Vida)</h2>
                            <div class="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-5 gap-4 auto-cols-fr">
                                <?php foreach ($arcanos as $key => $arcano): ?>
                                    ...
                                    ?>
                                    <div class="border border-green-300 rounded-lg p-4 <?php echo $isCurrent ? 'bg-green-500 text-white' : 'bg-white'; ?> shadow-sm flex flex-col items-start">
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?> font-semibold mb-2"><?php echo $arcano['arcano']; ?></p>
                                        <span class="border rounded-full px-3 py-1 font-medium <?php echo $isCurrent ? 'border-white' : 'border-orange-300 text-orange-700'; ?> mb-2"><?php echo $arcano['arcano']; ?></span>
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?>">De <?php echo convertDate($arcano['inicio']); ?> até <?php echo convertDate($arcano['fim']); ?></p>
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?>"><?php echo $arcano['idadeInicio']; ?> a <?php echo $arcano['idadeFim']; ?> anos</p>
                                        <div class="flex justify-end mt-2 w-full">
                                            <a class="text-sm underline <?php echo $isCurrent ? 'text-white' : 'text-blue-600 hover:text-blue-800'; ?>" href="#" data-modal="<?php echo "modal-arcano-vida-$key" ?>">Ver detalhes</a>
                        ...
                        <!-- Arcanos (Pessoal) -->
                        <div id="arcanoTalento" class="arcano-container bg-gray-50 rounded-2xl p-6 shadow-md hidden">
                            <h2 class="text-xl font-semibold text-gray-800 mb-6">Arcanos (Pessoal)</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-cols-fr">
                                <?php foreach ($arcanos_pessoais as $key => $arcano): ?>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 <?php echo $isCurrent ? 'bg-green-500 text-white' : 'bg-white'; ?> shadow-sm flex flex-col items-start">
                                        ...
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?>"><?php echo $arcano['idadeInicio']; ?> a <?php echo $arcano['idadeFim']; ?> anos</p>
                                        <div class="flex justify-end mt-2 w-full">
                                            <a class="text-sm underline <?php echo $isCurrent ? 'text-white' : 'text-blue-600 hover:text-blue-800'; ?>" href="#" data-modal="<?php echo "modal-arcano-pessoal-$key" ?>">Ver detalhes</a>
                        ...
                        <!-- Arcanos (Social) -->
                        <div id="arcanoAscensao" class="arcano-container bg-gray-50 rounded-2xl p-6 shadow-md hidden">
                            <h2 class="text-xl font-semibold text-gray-800 mb-6">Arcanos (Social)</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-cols-fr">
                                <?php foreach ($arcanos_sociais as $key => $arcano): ?>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 <?php echo $isCurrent ? 'bg-green-500 text-white' : 'bg-white'; ?> shadow-sm flex flex-col items-start">
                                        ...
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?>"><?php echo $arcano['idadeInicio']; ?> a <?php echo $arcano['idadeFim']; ?> anos</p>
                                        <div class="flex justify-end mt-2 w-full">
                                            <a class="text-sm underline <?php echo $isCurrent ? 'text-white' : 'text-blue-600 hover:text-blue-800'; ?>" href="#" data-modal="<?php echo "modal-arcano-social-$key" ?>">Ver detalhes</a>
                        ...
                        <!-- Arcanos (Destino) -->
                        <div id="arcanoOculta" class="arcano-container bg-gray-50 rounded-2xl p-6 shadow-md hidden">
                            <h2 class="text-xl font-semibold text-gray-800 mb-6">Arcanos (Destino)</h2>
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-cols-fr">
                                <?php foreach ($arcanos_destino as $key => $arcano): ?>
                                    ...
                                    <div class="border border-green-300 rounded-lg p-4 <?php echo $isCurrent ? 'bg-green-500 text-white' : 'bg-white'; ?> shadow-sm flex flex-col items-start">
                                        ...
                                        <p class="text-sm <?php echo $isCurrent ? 'text-white' : 'text-gray-800'; ?>"><?php echo $arcano['idadeInicio']; ?> a <?php echo $arcano['idadeFim']; ?> anos</p>
                                        <div class="flex justify-end mt-2 w-full">
                                            <a class="text-sm underline <?php echo $isCurrent ? 'text-white' : 'text-blue-600 hover:text-blue-800'; ?>" href="#" data-modal="<?php echo "modal-arcano-destino-$key" ?>">Ver detalhes</a>
